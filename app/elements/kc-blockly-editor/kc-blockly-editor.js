...
Polymer({
  _template: html`
        ...
        <kwc-blockly id="code-editor" toolbox="[[toolbox]]" on-change="_onBlocklyChanged" on-code-changed="_onCodeChanged" on-blockly-ready="_onBlocklyReady" no-trashcan="[[simple]]" no-zoom-control="[[simple]]" no-toolbox="[[simple]]">
